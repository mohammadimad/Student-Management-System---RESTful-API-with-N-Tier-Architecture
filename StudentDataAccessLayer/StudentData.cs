...
namespace StudentDataAccessLayer
{
    ...
    {
        static string _connectionString = "Server=.;Database=Employees;User Id=sa;Password=sa123456;Encrypt=False;TrustServerCertificate=True;Connection Timeout=30;";
